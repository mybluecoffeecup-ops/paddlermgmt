...
export const MOCK_SHOP_ORDERS: ShopOrder[] = [
  ...
  {
    id: "shop-order-2",
    paddler_id: SHOP_PADDLER_B,
    status: "accepted",
    created_at: now,
    updated_at: now,
    decided_at: now,
    decided_by: CURRENT_COACH_ID,
  },
  {
    id: "shop-order-3",
    paddler_id: CURRENT_USER_ID,
  ...
  },
  {
    ...
    updated_at: now,
    decided_at: now,
    decided_by: SHOP_PADDLER_B,
  },
];

export const MOCK_SHOP_ORDER_ITEMS: ShopOrderItem[] = [
  {
