...
src/
  ...
  components/
    ...
    shop/                  # ShopBrowseGrid, ShopStyleDetail (size chart + add to cart), ShopCart, MyOrders,
                           # ShopStyleManager, ShopSizeChartManager, ShopOrderQueue, ShopSalesHistory (coach)
